...
DROP SEQUENCE code_number;

CREATE SEQUENCE get_obj_id START WITH 1354 MAXVALUE 999999 INCREMENT BY 1 NOCACHE CYCLE;
CREATE SEQUENCE code_number START WITH 1139 MAXVALUE 999999 INCREMENT BY 1 NOCACHE CYCLE;
...
INSERT INTO ATTRTYPE (ATTR_ID, OBJECT_TYPE_ID, OBJECT_TYPE_ID_REF, CODE, NAME)
VALUES (13, 5, NULL, 'DATE', NULL);

INSERT INTO ATTRTYPE (ATTR_ID, OBJECT_TYPE_ID, OBJECT_TYPE_ID_REF, CODE, NAME)
VALUES (14, 5, 1, 'MOVIE_REF', NULL);

INSERT INTO ATTRTYPE (ATTR_ID, OBJECT_TYPE_ID, OBJECT_TYPE_ID_REF, CODE, NAME)
VALUES (15, 5, 2, 'HALL_REF', NULL);

INSERT INTO ATTRTYPE (ATTR_ID, OBJECT_TYPE_ID, OBJECT_TYPE_ID_REF, CODE, NAME)
VALUES (16, 6, NULL, 'CODE', NULL);

INSERT INTO ATTRTYPE (ATTR_ID, OBJECT_TYPE_ID, OBJECT_TYPE_ID_REF, CODE, NAME)
VALUES (17, 6, NULL, 'EMAIL', NULL);

INSERT INTO ATTRTYPE (ATTR_ID, OBJECT_TYPE_ID, OBJECT_TYPE_ID_REF, CODE, NAME)
VALUES (18, 6, NULL, 'PRICE', NULL);

INSERT INTO ATTRTYPE (ATTR_ID, OBJECT_TYPE_ID, OBJECT_TYPE_ID_REF, CODE, NAME)
VALUES (19, 6, NULL, 'IS_PAID', NULL);

INSERT INTO ATTRTYPE (ATTR_ID, OBJECT_TYPE_ID, OBJECT_TYPE_ID_REF, CODE, NAME)
VALUES (20, 6, 5, 'SEANCE_REF', NULL);

INSERT INTO ATTRTYPE (ATTR_ID, OBJECT_TYPE_ID, OBJECT_TYPE_ID_REF, CODE, NAME)
VALUES (21, 6, 4, 'PLACE_REF', NULL);

INSERT INTO ATTRTYPE (ATTR_ID, OBJECT_TYPE_ID, OBJECT_TYPE_ID_REF, CODE, NAME)
VALUES (22, 7, NULL, 'PRICE', NULL);

INSERT INTO ATTRTYPE (ATTR_ID, OBJECT_TYPE_ID, OBJECT_TYPE_ID_REF, CODE, NAME)
VALUES (23, 7, 3, 'ZONE_REF', NULL);

INSERT INTO ATTRTYPE (ATTR_ID, OBJECT_TYPE_ID, OBJECT_TYPE_ID_REF, CODE, NAME)
VALUES (24, 7, 5, 'SEANCE_REF', NULL);