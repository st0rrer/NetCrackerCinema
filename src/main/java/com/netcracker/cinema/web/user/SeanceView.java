...
public class SeanceView extends GridLayout implements View {
    ...
    @PostConstruct
    void initFilters() {
        SeanceFilterComponent SeanceFilter = new SeanceFilterComponent();
    ...
    void init() {
        ...
        for (Seance seance : seances) {
            SeanceComponent seanceComponent = new SeanceComponent(seance, movieService);
